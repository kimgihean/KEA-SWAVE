...
const About = () => { 
    ...
    const teammates=[
        {number:"201835610",name:"강준희",info:"18학번 소프트웨어학과 강준희입니다.",desc:"KEA에 참여하여 데이터 관리기술, 차세대 챗봇, 시스템 아키택처를 수강하고 있습니다.\n한 학기동안 열심히 배워 시스템 아키텍처가 되겠습니다.",img:profile1},
        {number:"201732505",name:"김기현",info:"17학번 ~과 김기현입니다.",desc:"KEA 에서 많은 기술을 배워서 사회가 원하는 소프트웨어 엔지니어가 되겠습니다.\nrlgus2738@naver.com",img:profile2},
